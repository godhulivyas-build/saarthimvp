...
export const MonitoringPage: React.FC = () => {
  return (
    <div className="space-y-3">
      <h2 className="sarthi-headline text-xl sm:text-2xl font-extrabold">Grafana monitoring</h2>
      ...
      <ul className="text-sm text-[var(--sarthi-on-surface-variant)] space-y-1">
      ...
      <p className="text-xs text-[var(--sarthi-on-surface-variant)]">Install notes: `docs/drdroid/monitoring.md`</p>
    </div>
  );
};
