...
| Path | Contents |
|------|----------|
| [`stitch-sarthi/pragati_sangam/DESIGN.md`](stitch-sarthi/pragati_sangam/DESIGN.md) | Tokens, typography (Plus Jakarta + Inter), surfaces, Sarthi Didi rules |
| `stitch-sarthi/*/code.html` | Static reference screens (landing, onboarding, farmer, buyer, logistics) |
